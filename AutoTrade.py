...
if __name__ == '__main__': 
    try:
        ...
        buy_percent = 0.25   # 각 종목에 사용할 투자금(%), 25%
        ...
        while True:
            ...
            t_start = t_now.replace(hour=9, minute=5, second=0, microsecond=0)  # 09시05분
            t_sell = t_now.replace(hour=15, minute=15, second=0, microsecond=0) # 15시15분
            t_exit = t_now.replace(hour=15, minute=20, second=0,microsecond=0)  # 15시20분
